...
const clearCartItem = (cartItems: CartItemQuantity[], cartItemToClear: CartItemQuantity): CartItemQuantity[] => 
...
export const setCartItems = withMatcher((cartItems: CartItemQuantity[]): SetCartItems => 
