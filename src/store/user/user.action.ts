...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AddittionalInformation}>;
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AddittionalInformation): SignUpSuccess =>
